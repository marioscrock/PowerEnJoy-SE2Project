...
This rating measures the schedule constraint imposed on the project team developing the software. Since the schedule considers mandatory deadlines, this parameter is set to \textbf{NOMINAL}.
