...
\paragraph{Notes} The method \emph{checkAndSet} refers to an atomic operation that checks if the carJPA status is \emph{Available} and set its status as \emph{Reserved} for the userID given as parameter.
