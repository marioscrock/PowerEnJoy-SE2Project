...
\fancypagestyle{SE2}{% Software Engineering 2 Project Page Style
	...
	\fancyfoot[L]{\emph{PowerEnJoy}\quad \textbf{I}ntegration \textbf{T}est \textbf{P}lan \textbf{D}ocument}
	\fancyfoot[R]{\thepage}
...
\include{ITPD_introduction}

\include{ITPD_integrationstrategy}

\include{ITPD_testdescription}

\include{ITPD_tools}

\include{ITPD_stubsdata}

\include{ITPD_appendix}
