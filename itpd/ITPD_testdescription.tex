...
$\bullet$ An empty list of discounts and/or an empty list of fees\\\\
or & The fee and discount to apply are computed, a new payment is inserted properly in the DB with the paymentStatus attribute as \emph{Pending}\\\\
