...
\begin{itemize}
	...
	\item When the trigger method is called on \emph{CarHandler}, it enables the requested triggers on the car passed as a parameter. This allows the cars to notify to the system the events related to the aforementioned triggers; these events will be received and dispathced by the \emph{EventBroker}.
\end{itemize}
