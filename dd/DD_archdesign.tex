...
In the following table is presented a mapping correspondence between the requirement related to each goal and the components identified in the server component diagram. \todo{check} \\
