...
\subsubsection*{[27] Check that the code is free of duplicates, long methods, big classes, breaking encapsulation, as well as if coupling and cohesion are adequate}\todo{coperti da overload in altre classi}
...
\begin{description}
	\item[L 125:] the {\tt isOpen} method can be simplified by only returning the conjunction {\tt terminalState != null \&\&\\ terminalState.getDate("closedDate") == null} \todo{may be worse, but it works also against nullPE as the original}
