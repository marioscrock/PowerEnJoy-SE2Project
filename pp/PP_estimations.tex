...
This section describes the EOs and related FTRs and DETs identified for the \emph{Power EnJoy system} grouped by the user category.

\paragraph{Payment API}
\begin{itemize}
	\item \textbf{Make a payment procedure}
\end{itemize}

\paragraph{GIS API}
\begin{itemize}
	\item \textbf{Decode an address as GPS position}
	\item \textbf{Obtain a map reference}
\end{itemize}

\paragraph{Cars}
\begin{itemize}
	\item \textbf{Call car primitives}
\end{itemize}
...
\midrule
Make a payment procedure \\
\midrule
Decode an address as GPS position  \\
...
\paragraph{Registered user}
\begin{itemize}
	\item \textbf{See rent history}
	\item \textbf{See payment history}
\end{itemize}

\paragraph{Customer care user}
\begin{itemize}
	\item \textbf{See information about a user}
	\item \textbf{See rent history of a user}
	\item \textbf{See payment history of a user}
\end{itemize}
...
\midrule
See own rent history\\
See own payment history\\
\midrule
See information about a user\\
See rent history of a user\\
See payment history of a user\\
\midrule
\textbf{Total} & & & &  42\\
\bottomrule \\
...
\end{itemize} 
 ...
 $$\textrm{Lower bound \textbf{SLOC}} = (\sum_{i \in I} \sum_{j \in i} w_{ij}) \cdot factor = 42 \cdot 46 = 7 $$
 
  $$\textrm{Upper Bound \textbf{SLOC}} = (\sum_{i \in I} \sum_{j \in i} w_{ij}) \cdot factor = 42 \cdot 67 = 7 $$