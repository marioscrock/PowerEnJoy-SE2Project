...
\midrule
\textbf{Entry conditions} & Maintenance service system must know the encrypted password to be identified by the system\\
\midrule
\textbf{Flow of events} & 
\begin{enumerate}
	\item The maintenance service system asks for the list of car with state set as \emph{Not Available} sending the request
	paired with the encrypted password
	\item The system checks the encrypted password
...
\textbf{Exceptions} & 
\begin{itemize}
	\item If encrypted password sent by the maintenance service system is not recognized, the system sent to the maintenance service system an error message
\end{itemize} \\
\bottomrule
\end{tabular}
