...
Also the integration between the maintenance subsystem and the API interface exposed externally has to be tested, checking the token mechanism and its correctly behaviour for an API-user external to the system (see the \emph{PowerEnJoy: Design Document} \cite{DD} for more details).
\paragraph{}
