...
\begin{figure}[h!]
	\centering
	\includegraphics[angle=90,width=0.9685\linewidth]{sequenceDiagrams/UnlockStartRent}
	\caption{
...
\begin{figure}[h!]
	\centering
	\includegraphics[angle=90,width=0.9685\linewidth]{sequenceDiagrams/EndRent}
	\caption{
...
\begin{figure}[h!]
	\centering
	\includegraphics[angle=90,width=0.9685\linewidth]{sequenceDiagrams/EndRent2}
	\caption{
