...
\todo{Car reservation punto 2: retrieves->refresh, punto 5 unire a punto 3}
\begin{tabular}{p{0.25\linewidth}p{0.75\linewidth}}
\toprule
...
\midrule
\textbf{Entry conditions} & The user must not have a reservation active \\
\midrule
\textbf{Flow of events} & 
\begin{enumerate}
	...
	\item The system show the user information about car battery percentage
