...
\newcommand{\specialcell}[2][c]{%
  \begin{tabular}[#1]{@{}c@{}}#2\end{tabular}} % line break in tables
\newenvironment{newCenterWithoutTopMargin}{\setlength\topsep{0pt}\center}{\endcenter} %Dado beautiful new center environment
\newcommand{\DadoCenter}[1]{\begin{newCenterWithoutTopMargin}#1\end{newCenterWithoutTopMargin}} %Dado beautiful new center environment
...
\include{PP_introduction}

\include{PP_estimations}

\include{PP_estimations_cocomo}

\include{PP_schedule}

\include{PP_allocation}
