...
\paragraph{Security}Users' passwords and all credit card numbers (associated to the users and used for past payments) must be stored 
with proper and secure encryption.
