	...
	\begin{description}
		...
		cars
			\begin{enumerate}[resume*]
   				...
   				available
   				\item The system must offer an API to retrieve the list of cars marked as
   				\emph{Not Available} along with the current position of each car
   				(\emph{GPS coordinates})
  			\end{enumerate}
