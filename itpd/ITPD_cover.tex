...
\HRule \\[0.4cm]
{ \huge \bfseries Integration Test Plan Document}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
{\large January 15, 2017}\\[0.5cm] % Date, change the \today to a set date if you want to be precise
