...
The world and the machine \cite{WorldMachine} \todo{Add text, citation is already correct}\\
\begin{figure}[h!]
	\centering
...
The world and the machine is a way of thinking about problems and phenomena relevant in the reality of the software system we are to develop. The world contains the phenomena that happens in reality but are not seen from our system; the machine instead contains the phenomena which take place inside the system and are not visible outside of it. The interception between these two sets of phenomena contains the so called set of shared phenomena, which contains the phenomena that take place inside the machine, but are visible from the world and vice-versa.
\clearpage