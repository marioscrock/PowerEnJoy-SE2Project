...
\begin{enumerate}
    ...
    \item When the timer expires:
    	\begin{enumerate}[label = 8.\arabic*]
    		\item The system retrieves informations about the ride from the car: number of passengers detected during the ride, position and battery level at the end of the ride and if the car is or not on charge 
